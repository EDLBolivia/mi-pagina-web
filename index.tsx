async function generateTitle(documentType: string, area: string, topic: string, focus: string, objective: string, company: string) {
    setLoading(true);
...
function App() {
    ...
    const docTypeSelect = document.getElementById("document-type") as HTMLSelectElement;
    const companyGroup = document.getElementById("company-group");

    docTypeSelect?.addEventListener("change", () => {
        if (docTypeSelect.value === "Proyecto de Grado") {
    ...
    titleForm?.addEventListener("submit", (e) => {
        ...
        const focus = (document.getElementById("focus") as HTMLInputElement)?.value;
